...
#         self.itemEmbed_g.weight.register_hook(self.save_grad('itemEmbed_g'))
    ...
    def get_paras(self,users,items):
        reference_point = self.reference_point(users)
        ...
        return [alpha,beta,lamda,gamma,delta,reference_point]
	
class PT_LogSoftmax(nn.Module):
    def __init__(self, userLen, itemLen, distribution, params, item_price):
        super(PT_LogSoftmax, self).__init__()
        self.userNum = userLen
        self.itemNum = itemLen
        self.params = params
...
class PT_RP(nn.Module):
    def __init__(self, userLen, itemLen, distribution, params, item_price):
        super(PT_RP, self).__init__()
        self.userNum = userLen
        self.itemNum = itemLen
        self.params = params
...
class PT_VF(nn.Module):
    def __init__(self, userLen, itemLen, distribution, params, item_price):
        super(PT_VF, self).__init__()
        self.userNum = userLen
        self.itemNum = itemLen
        self.params = params
...
class PT_WF(nn.Module):
    def __init__(self, userLen, itemLen, distribution, params, item_price):
        super(PT_WF, self).__init__()
        self.userNum = userLen
        self.itemNum = itemLen
        self.params = params
